...
namespace Grimoire
{
    internal class EbnfRepeatExpression : EbnfUnaryExpression, IEquatable<EbnfRepeatExpression>, ICloneable
    {
        ...
        public override IList<IList<string>> ToDisjunctions(EbnfDocument parent, Cfg cfg)
        {
            ...
            var expr = new EbnfOrExpression(
                new EbnfOrExpression(new EbnfConcatExpression(Expression, new EbnfRefExpression(_listId)), Expression),
                null);
            ...
            return new List<IList<string>>(new IList<string>[] { new List<string>(new[] { _listId }) });
        }
