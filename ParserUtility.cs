...
namespace Grimoire
{
    internal static class ParserUtility
    {
        ...
        public static IEnumerable<char> ExpandRanges(IEnumerable<KeyValuePair<char, char>> ranges)
        {
            ...
            foreach (var ch in ExpandRange(range))
                yield return ch;
        }

        private static (int Accept, string Value, (int First, int Last)[] ExpectingRanges, int[] ExpectingSymbols)
            DoRecoveryDfat(
                (int Accept, ((char First, char Last)[] Ranges, int Destination)[] Transitions, int[] PossibleAccepts)[]
                    dfaTable,
                (int Accept, ((char First, char Last)[] Ranges, int Destination)[] Transitions, int[] PossibleAccepts)
        ...
        private static int GetDfatTransition(((char First, char Last)[] Ranges, int Destination)[] trns, char ch)
        {
